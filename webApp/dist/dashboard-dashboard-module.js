...
module.exports = "\n<h4> Tell us about your legal problem, and we'll show you relevant results with insights. </h4>\n<mat-form-field class=\"query-full-width\">\n  <input matInput [(ngModel)]=\"userQuery\" placeholder='keep your search precise'>\n</mat-form-field>\n\n<div class=\"example-button-row\">\n  <button mat-raised-button color=\"primary\" (click)=\"submitForm()\">Search</button>\n</div>"
...
module.exports = "table {\n  width: 100%; }\n\n.mat-card {\n  text-align: center; }\n\n.mat-card img {\n    border-radius: 5px;\n    margin-top: -25px; }\n\n.mat-table {\n  box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12); }\n\n.mb-20 {\n  margin-bottom: 20px; }\n\n.query-full-width {\n  width: 75%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(_rest, dashboardService) {
        this._rest = _rest;
    ...
    DashboardComponent.prototype.submitForm = function () {
        ...
        this.dashboardService.searchQuery(this.userQuery).subscribe(function (searchResult) {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_rest_service__WEBPACK_IMPORTED_MODULE_1__["RestService"], _dashboard_service__WEBPACK_IMPORTED_MODULE_2__["DashboardService"]])
    ], DashboardComponent);
...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.searchQuery = function (search_string) {
        var opts;
        opts = {
            headers: this.getCommonHeaders(),
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('page', '0').set('search_string', search_string)
        };
        var search_url = "localhost:8080/summarizer";
        return this.http.get(search_url, opts).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            var searchResult = res;
            console.log(searchResult);
            return searchResult;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleErrors));
    };
    DashboardService.prototype.getCommonHeaders = function () {
